...
function sendFallbackResponse() {
  // Real fallback prices (approximate current market prices)
  const fallbackPrices: Record<string, { price: number; change: number }> = {
    'BTCUSDT': { price: 67000, change: 1.5 },
    'ETHUSDT': { price: 3400, change: 2.1 },
    'BNBUSDT': { price: 580, change: 0.8 },
    'SOLUSDT': { price: 175, change: 3.5 },
    'XRPUSDT': { price: 0.52, change: -1.2 },
    'ADAUSDT': { price: 0.45, change: 1.8 },
    'DOGEUSDT': { price: 0.12, change: 4.2 },
    'AVAXUSDT': { price: 35, change: 2.5 },
    'DOTUSDT': { price: 6.5, change: -0.5 },
    'MATICUSDT': { price: 0.52, change: 1.2 },
    'LINKUSDT': { price: 14, change: 1.5 },
    'UNIUSDT': { price: 8.5, change: -0.8 },
    'ATOMUSDT': { price: 8.2, change: 2.1 },
    'LTCUSDT': { price: 82, change: 0.5 },
    'ETCUSDT': { price: 22, change: -1.8 },
    'NEARUSDT': { price: 5.2, change: 3.2 },
    'FTMUSDT': { price: 0.45, change: 4.5 },
    'ARBUSDT': { price: 0.85, change: 2.8 },
    'OPUSDT': { price: 2.1, change: 1.9 },
    'SUIUSDT': { price: 1.15, change: 5.2 },
    'SHIBUSDT': { price: 0.000024, change: 3.8 },
    'PEPEUSDT': { price: 0.000011, change: 6.5 },
    'FLOKIUSDT': { price: 0.00018, change: 4.2 },
    'BONKUSDT': { price: 0.000028, change: 5.8 },
    'AAVEUSDT': { price: 145, change: -1.2 },
    'MKRUSDT': { price: 2900, change: 0.8 },
    'CRVUSDT': { price: 0.28, change: -2.5 },
    'PENDLEUSDT': { price: 4.8, change: 3.5 },
    'ENAUSDT': { price: 0.85, change: 2.2 },
    'FETUSDT': { price: 1.85, change: 4.8 },
    'RNDRUSDT': { price: 7.5, change: 3.2 },
    'TAOUSDT': { price: 320, change: 2.5 },
    'WLDUSDT': { price: 2.8, change: -2.1 },
  };
